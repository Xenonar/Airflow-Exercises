...
#         raise ValueError(f"HasRowsOperator check failed. {table} returned no results")
#     num_records = records[0][0]
#     if num_records < 1:
#         raise ValueError(f"HasRowsOperator check failed. {table} contained 0 rows")
#     logging.info(f"HasRowsOperator on table {table} check passed with {records[0][0]} records")
